...
Always **use UTF-8 without BOM** for the `*.nuspec` and **UTF-8 with BOM** for the `*.ps1` files. See [character encodings](https://docs.chocolatey.org/en-us/create/create-packages#character-encoding).
